...
bool PlaneDetection::readColorImage(cv::Mat color_img_) //(string filename)
{
...
bool PlaneDetection::readDepthImage(cv::Mat depth_img) //(string filename)
{
...
cv::Mat PlaneDetection::writeOutputFiles(string output_folder, string frame_name, bool run_mrf)
{
