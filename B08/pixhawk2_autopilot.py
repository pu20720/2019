################################################################################################
# @File pixhawk2_autopilot.py
# usage of DroneKit with Pixhawk2
# Pixhawk2 connect to NVIDIA Jetson TX2
#
# @author TSAI MIN-HENG
#
...
vehicle = connect('/dev/ttyTHS2', baud=921600) # , wait_ready=True
